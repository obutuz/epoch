...
stack(_Cfg) ->
    ...
    Env       = create_contract(101, Code, "()", initial_state(#{})),
    {0, Env1} = successful_call(101, word, size, "()", Env),
    {1, Env2} = successful_call(101, word, push, "\"foo\"", Env1),
    {<<"foo">>, _Env3} = successful_call(101, string, pop, "\"foo\"", Env2),
    ok.
